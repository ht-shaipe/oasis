...
use ui_schema::{HostContext, WasmManifest};
...
fn inject_host_functions(store: &mut Store<HostState>, linker: &mut Linker<HostState>) {
    let module = ui_schema::HostEnv::MODULE_NAME;
    ...
    linker
        .define(
            module,
            ui_schema::HostEnv::FN_GET_CONTEXT,
    ...
    linker
        .define(
            module,
            ui_schema::HostEnv::FN_READ_FILE,
    ...
    linker
        .define(
            module,
            ui_schema::HostEnv::FN_WRITE_FILE,
    ...
    linker
        .define(
            module,
            ui_schema::HostEnv::FN_SHOW_NOTIFICATION,
