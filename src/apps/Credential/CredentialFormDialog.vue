    ...
    <AppDialog
        ...
        <el-form
            ...
            <div
                ...
                <el-button text class="mt-2" @click="addAccountSet">
            ...
            <div
                v-else
                class="space-y-2 border border-solid border-[var(--color-window-titlebar-border)] rounded-2 p-2">
